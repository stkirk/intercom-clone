  ...
  initialMessage: {
    ...
    responseOptions: [
      ...
      },
      {
        name: "referTo",
        value: "sales",
        text: "I want to learn more about the product",
        nextMessage: "b1",
      },
      {
        name: "existingCustomer",
        value: true,
        text: "I'm a current customer with a question",
        nextMessage: "c1",
      },
    ],
  },
  a1: {
    ...
    responseOptions: [
      ...
      },
      {
        name: "referTo",
        value: "sales",
        text: "Somewhat familiar but looking for more information",
        nextMessage: "b1",
      },
      {
        name: "existingCustomer",
        value: true,
        text: "I'm a current customer",
        nextMessage: "c1",
      },
    ],
  },
